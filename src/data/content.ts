...
export const RECRUIT = {
  ...
  features: {
    ...
    items: [
      ...
      {
        tag: "STEP UP",
        title: "働きながら、独立の土台をつくれる",
        text: "現場で仕事を覚えながら、営業・マーケティング・マネジメントまで実践の中で培っていきます。経験や資金の有無にかかわらず、「稼ぎながら学ぶ」ことができる。将来、自分の事業を動かせるようになるための基盤を、ここでつくってほしいと思っています。",
      },
    ],
  },
